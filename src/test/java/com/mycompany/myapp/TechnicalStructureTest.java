...
@AnalyzeClasses(packagesOf = EcommercesiteApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(EcommercesiteApp.class), alwaysTrue())
