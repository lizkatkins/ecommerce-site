...
@RestController
@RequestMapping("/api/ecommercesite-kafka")
public class EcommercesiteKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EcommercesiteKafkaResource.class);
    ...
    public EcommercesiteKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
